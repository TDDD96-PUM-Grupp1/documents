...
\section{Krav}
	...
	\begin{tabular}{| p{2cm} | p{8cm} | p{2cm}|}
		...
		\Krav{Spelaren ska kunna sätta ett unikt användarnamn.}{1}
		\Krav{Kontrollapplikationen ska kunna köras på en enhet som har minst version 64 av Google Chrome.}{1}
		...
		\Krav{Kontrollapplikationen ska ha en knapp för att generera ett slumpmässigt användarnamn.}{2}
