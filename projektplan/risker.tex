...
\risk{En projektmedlemm blir sjuk eller hoppar av}{1}{4}
{
    Om en projektmedlemm blir sjukt under längre tid eller hoppas av kan arbetet ta skada. För att minska risken att arbetet går dåligt ska projektmedlemmarna jobba i par. På det sättet delas kunskapen om ämnet de jobbar på upp, och arbetet har mindre risk att bli fördröjt. Om någon försvinner från projektet kommer också ett möte hållas för att strukturera om arbetsuppgifter på ett lämpligt sätt.
}

\risk{Medlemmar lägger för lite tid och projektet kan misslyckas}{2}{4}
{
    Om det skulle visa sig att flera projektmedlemmar inte lägger tillräckligt många timmar på projektet kan detta leda till ett misslyckat projekt. Projektgruppen har en burndown-chart i sin tidsrapportering där de enkelt kan se om de ligger efter i timmar. Med detta kan gruppen strukturera upp kommande arbete och förhoppningsvis lyckas med projektet.
}

\risk{Integration av komponenter leder till att buggar uppstår}{2}{2}
{
    Eftersom projektet består av flera moduler kommer integration mellan dessa ske. När detta händer kan buggar förekomma som kan blir svåra att felsöka. För att minska risken att detta påverkar arbetet negativt kommer gruppen ha kontinuerliga integrationstester. Med hjälp av detta kan eventuella buggar hittas och tydliggöras tidigt i utvecklingen.
}
