...
\noindent
	\begin{tabular}{| p{2.1cm}| p{5cm}| p{1.2cm}| p{7cm}|}
		...
		\hline
		Systemtest 3&Användarnamn i kontroll ska visas på UI.&OK&Test utfört manuellt, testrapport kan återfinnas här: \ref{sec:appendix}\\
		\hline
		...
		\hline
		Systemtest 6&Om poäng ges till spelare ska highscorelistan uppdateras i kontrollen.&OK&Test utfört manuellt, testrapport kan återfinnas här: \ref{sec:appendix} ID: ui-highscoresort\\
		\hline
