...
Utifrån det kan man ställa in vilket interface man lyssnar på, detta inkluderar generellt Bluetooth, ethernet och loopback.\cite[p.~364]{networking} I denna rapporten kommer loopback interface användas, detta interface är till för att skicka nätverksdata till och från samma dator. Det vill säga den data som inte skickas till en annan dator.
