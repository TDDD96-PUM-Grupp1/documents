...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{systemanatomi_spel}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{systemanatomi_graf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{konceptarkitektur}
