...
\subsection{Git}
Git är ett decentraliserat versionshanteringsprogram för kod. Git fungerar på så sätt att en person som vill använda koden klonar hela Gitrepot, skriver sina ändringar, 
