...
\begin{itemize}
	\item \textit{Pull request}: När en utvecklare tar in förändringar ifrån ett annat arkiv till sitt eget så kallas denna handling för en \textit{pull request}. Detta kan ske antingen när en utvecklares lokala arkiv tar in förärndringar ifrån det centrala arkivet, eller när det centrala arkivet tar in utvecklarens lokala förändringar.
...
Ett opensource projekt som används för versionhantering av kod  .
