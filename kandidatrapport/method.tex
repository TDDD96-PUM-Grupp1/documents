...
\subsection{Enkät}
För att verifiera att produkten håller bra kvalitet bestämde gruppen sig för att genomföra en enkätundersökning. I denna undersökning fick 20 personer testa att använda produkten och sedan skriva ett enkät gällande hur de upplevde att använda produkten. De valda testpersonerna kom ifrån två grupper, andra studenter slumpmässigt valda på Linköpings Universitets campus. Den andra gruppen bestod av slumpmässigt anställda på Cybercom. Dessa personer fick testa spelet i ungefär fem minuter och sedan svara på en enkät med följande frågor. På varje fråga fick ett betyg ges mellan ett och tio där ett är helt emot och tio betyder att man instämmer helt.
