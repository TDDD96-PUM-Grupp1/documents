...
Travis är ett verktyg som kör förskrivna tester vid varje pull request eller push till en gren. Om dessa tester skulle misslyckas vid en pull request från master-branchen nekas integrationen. En push kommer alltid lyckas även vid ett misslyckat test, men travis noterar att testet har misslyckats. Vertyget sparade projektgruppens tid genom att verifiera att koden verkligen fungerade givet att bra tester hade skrivits.\\
