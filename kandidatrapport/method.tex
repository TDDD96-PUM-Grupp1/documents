...
Anatomin för systemet beskrev hur systemet är uppbyggt på olika nivåer, såsom funktioner, mjukvara och hårdvara. Anatomin gav en större bild av hur systemet fungerade och beskrev vilken miljö den kommer befinna sig i.
